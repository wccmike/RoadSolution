...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link rel="stylesheet" href="assets/css/mainst.css">
...
<body style="background-color: #1c77ac; background-image: url(assets/images/light.png); background-repeat: no-repeat; background-position: center top; overflow: hidden;">
    <form id="form1" runat="server" method="post">
        ...
        <div class="loginbody">
            ...
            <%--无用户或密码错误--%>
        <div id="mes"><p id="parname" runat="server"></p></div>
            ...
            <div class="loginbox">
                ...
                <ul>
                    ...
                    <li>
                        <asp:TextBox ID="uname" runat="server" CssClass="loginuser" AutoCompleteType="Disabled"></asp:TextBox></li>
                    <li><%--<input type="text" name="pwd"  class="loginpwd" onclick="JavaScript: this.value = ''"/>--%>
                        <asp:TextBox ID="pwd" runat="server" CssClass="loginpwd" AutoCompleteType="Disabled" TextMode="Password"></asp:TextBox>
                    </li>
                    ...
                    <li>
                        ...
                        <asp:HyperLink ID="HLRegister" runat="server" NavigateUrl="~/Register.html">注册</asp:HyperLink>
                    </li>
                    <li>
                        <label>
